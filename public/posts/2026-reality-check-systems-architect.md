...
1. **Watch:** The agent watches a folder for new PDFs.
2. **Think:** It extracts the data and turns it into a structured format.
3. **Check:** It compares that data to your records.
4. **Finish:** It updates your database and drafts your reply.
